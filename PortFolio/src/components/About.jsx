      ...
      <section className="rowin h-[100vh] bg-slate-900 lg:h-full" id="about">
        ...
        <div className="about-img">
          ...
          <div className="about-text p-5 text-left">
            <h1 className="text-[2.8rem] leading-[1] pb-4 lg:text-[1.5rem] lg:text-center">
              About <span className="text-blue-500">Me</span>
            </h1>
            <h4 className="text-[24px] font-semibold leading-[1.7] mt-4 mb-7 lg:text-[1.2rem] lg:text-center lg:mb-2 lg:mt-2">Creative & Techie Developer!</h4>
