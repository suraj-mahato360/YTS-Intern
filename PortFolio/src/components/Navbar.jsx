...
const Navbar = () => {
  ...
  return (
    <div>
      <header className='fixed w-full top-0 z-[1000] flex h-[10vh] justify-between bg-slate-900/50 pl-28 pr-28 py-5 items-center border-b-2 border-b-blue-400 shadow-lg sm:justify-between sm:pl-0 sm:pr-0'>
        ...
        <div className="m flex items-center">
            <a href="https://github.com/suraj-mahato360" className="github hover:drop-shadow-md hover:scale-105" target="_blank"><i className="ri-github-fill text-blue-400 text-5xl"></i></a>
            <a href="https://www.linkedin.com/in/suraj-mahato-732a2a20b/" className="linkedin hover:drop-shadow-md hover:scale-105" target="_blank"><i className="ri-linkedin-box-fill text-blue-600 text-5xl "></i></a>
